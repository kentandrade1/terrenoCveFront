          ...
          children: [
            ...
            pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 20),
                pw.Text('Cálculos de Cotización:',
                    style: pw.TextStyle(
                ...
                pw.Table.fromTextArray(
                  ...
                  data: [
                    [
                      'Entrada Terreno + Plan Ideal',
                      '\$${entradaTerrenoPlanIdeal.toStringAsFixed(2)}'
                    ],
                    [
                      'Cuotas Terreno + Plan Ideal',
                      '\$${cuotasTerrenoPlanIdeal.toStringAsFixed(2)}'
                    ],
                    ['Mensual', '\$${valorMensual.toStringAsFixed(2)}'],
                    [
                      'Total Terreno + Plan Ideal',
                      '\$${totalTerrenoPlanIdeal.toStringAsFixed(2)}'
                    ],
                  ],
                ),
              ],
...
class TerrenosAsesorView extends StatefulWidget {
  @override
  _TerrenosAsesorViewState createState() => _TerrenosAsesorViewState();
}

class _TerrenosAsesorViewState extends State<TerrenosAsesorView> {
