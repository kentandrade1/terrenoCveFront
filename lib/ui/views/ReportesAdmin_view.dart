...
class ReportesAdminView extends StatefulWidget {
  @override
  _ReportesAdminViewState createState() => _ReportesAdminViewState();
}

class _ReportesAdminViewState extends State<ReportesAdminView> {
